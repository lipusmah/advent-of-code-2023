...
def solve_line(codes, groups, count=0, prev=None, breaked=False):
    ...
    for i, c in enumerate(codes):
        ...
        if c == "?":
            ...
            if prev == "#" and breaked:
                return solve_line(option2, gs, count, prev, breaked)
   
            if prev == "#" and count < group:
                return solve_line(option1, gs, count, prev, breaked)            

            return solve_line(option1, gs, count, prev, breaked) + solve_line(option2, gs, count, prev, breaked)
...
def solve(lines:list[str]):
    ...
    for i, l in enumerate(lines):
        ...
        permutation = solve_line(tuple(codes), tuple(groups*5))
        suma += permutation
    return suma
